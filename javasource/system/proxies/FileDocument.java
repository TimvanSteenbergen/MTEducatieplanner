...
public class FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("EmailService.Attachment", mendixObject.getType()))
			return emailservice.proxies.Attachment.initialize(context, mendixObject);
